...
func gfminMutation(start, end string, bank []string) int {
	if start == end {
		return 0
	}
...
func gftjminMutation(start, end string, bank []string) int {
	if start == end {
		return 0
	}
	bankSet := map[string]struct{}{}
...
func myminMutation(start, end string, bank []string) int {
	if start == end {
		return 0
	}
	//退化为Set
