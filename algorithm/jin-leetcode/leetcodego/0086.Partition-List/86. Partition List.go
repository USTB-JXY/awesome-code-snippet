...
func mypartition(head *ListNode, x int) *ListNode {
	littlehead, lagrehead := &ListNode{Val: 0, Next: nil}, &ListNode{Val: 0, Next: nil}
	little, lagre := littlehead, lagrehead
	...
	//           ----          l      lagre
	//  2 4 1 3 5->1{3}    2 1 1  4 3 5
	lagre.Next = nil
	little.Next = lagrehead.Next
